...
<!-- wp:group {"tagName":"main","metadata":{"name":"Main"},"className":"serinity-main serinity-page-home","style":{"dimensions":{"minHeight":"ch"},"spacing":{"blockGap":"0"}},"backgroundColor":"nacre","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
<main class="wp-block-group serinity-main serinity-page-home has-nacre-background-color has-background"><!-- wp:html -->
  <style>
  main.serinity-main {
    padding-bottom: 0;
  }
    #symptomes div.serinity-grid {
  ...
  <!-- wp:group {"tagName":"section","metadata":{"name":"Section Hero"},"className":"serinity-section animated fadeIn ","style":{"background":{"backgroundImage":{"url":"https://dev-cat-wp.marseaud.fr/wp-content/uploads/2025/02/Background.png","id":190,"source":"file","title":"Background"},"backgroundSize":"contain","backgroundRepeat":"no-repeat"}},"backgroundColor":"nacre","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
  <section id="hero" class="wp-block-group serinity-section animated fadeIn has-nacre-background-color has-background"><!-- wp:group {"metadata":{"name":"Bloc Texte"},"className":"serinity-blur serinity-hero-text","style":{"color":{"background":"#faf7f580"},"shadow":"0rem 0.2rem 0.2rem 0.1rem #00000040"},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between"}} -->
  ...
  <p class="ticss-eca52e40 has-heading-font-family has-serinity-xl-font-size">Retrouvez votre paix intérieure et reconnectez-vous à votre Essence profonde</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-group"><!-- wp:paragraph {"align":"center","className":"ticss-daf2548e","style":{"typography":{"fontStyle":"italic","fontWeight":"700"}},"fontFamily":"heading","hasCustomCSS":true,"customCSS":".ticss-daf2548e {\n    font-size:clamp(1.375rem,.9583rem + 2.0833vw,2.625rem)\n}\n"} -->
  <p class="has-text-align-center ticss-daf2548e has-heading-font-family" style="font-style:italic;font-weight:700"><mark style="background-color:#f3ede7" class="has-inline-color">Cette harmonie n'est pas un rêve inaccessible — c'est un chemin concret que nous pouvons parcourir ensemble.</mark></p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://dev-cat-wp.marseaud.fr/seance-decouverte/">Réservez un appel</a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons --></div>
  <!-- /wp:group --></div></div>
  <!-- /wp:cover -->
  ...
  <div id="coach-new" class="wp-block-group ticss-0973c116 has-background" style="background:linear-gradient(180deg,rgb(196,194,169) 0%,rgb(209,183,184) 100%);margin-top:0;margin-bottom:0;padding-right:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><!-- wp:group {"metadata":{"name":"Groupe avec Dégradé"},"className":"serinity-blur ticss-36f355a8 animated fadeInUp","style":{"color":{"gradient":"linear-gradient(180deg,rgba(218,216,200,0.5) 0%,rgb(209,183,184) 100%)"},"border":{"radius":{"topLeft":"50px","topRight":"50px"}},"spacing":{"padding":{"top":"var:preset|spacing|large","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|medium","margin":{"top":"-6rem"}}},"layout":{"type":"constrained"},"hasCustomCSS":true,"customCSS":"\n"} -->
  <div class="wp-block-group serinity-blur ticss-36f355a8 animated fadeInUp has-background" style="border-top-left-radius:50px;border-top-right-radius:50px;background:linear-gradient(180deg,rgba(218,216,200,0.5) 0%,rgb(209,183,184) 100%);margin-top:-6rem;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:group {"metadata":{"name":"Titraille"},"layout":{"type":"constrained"}} -->
  ...
  <!-- wp:buttons {"className":"animated fadeInUp","layout":{"type":"flex","justifyContent":"center"}} -->
  <div class="wp-block-buttons animated fadeInUp"><!-- wp:button {"textAlign":"center"} -->
  <div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button" href="https://dev-cat-wp.marseaud.fr/seance-decouverte/">Prendre rendez-vous</a></div>
  <!-- /wp:button -->
  
  <!-- wp:button {"textAlign":"center","backgroundColor":"taupe"} -->
  <div class="wp-block-button"><a class="wp-block-button__link has-taupe-background-color has-background has-text-align-center wp-element-button" href="https://dev-cat-wp.marseaud.fr/a-propos/">En apprendre plus sur moi</a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons --></div>
  <!-- /wp:group --></div>
  <!-- /wp:group -->
  
  <!-- wp:group {"metadata":{"name":"titre témoignages"},"className":"","layout":{"type":"constrained"},"hasCustomCSS":true} -->
  <div class="wp-block-group"><!-- wp:heading {"textAlign":"center","className":"ticss-e95e96f1","backgroundColor":"rose","hasCustomCSS":true,"customCSS":".ticss-e95e96f1 {\n  line-height: 1.1;\n}\n"} -->
  ...
  <!-- wp:group {"tagName":"section","metadata":{"name":"Témoignages"},"className":"serinity-section","style":{"background":{"backgroundImage":{"url":"https://dev-cat-wp.marseaud.fr/wp-content/uploads/2025/03/main-bichromie-2-scaled.jpg","id":296,"source":"file","title":"main-bichromie-2"},"backgroundSize":"cover","backgroundAttachment":"scroll","backgroundPosition":"100% 50%"},"spacing":{"padding":{"top":"var:preset|spacing|xxx-large","bottom":"var:preset|spacing|xxx-large"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"center"}} -->
  <section id="testimonies" class="wp-block-group serinity-section" style="padding-top:var(--wp--preset--spacing--xxx-large);padding-bottom:var(--wp--preset--spacing--xxx-large)"><!-- wp:group {"metadata":{"name":"Témoignages Container"},"className":"serinity-testimonies","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
  ...
  <!-- wp:group {"metadata":{"name":"Bandeau"},"className":"serinity-blur serinity-bandeau animated fadeIn","style":{"color":{"background":"#f3ede780"},"spacing":{"padding":{"top":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small","right":"var:preset|spacing|small"},"margin":{"top":"0","bottom":"0"}},"shadow":"0rem 0.2rem 0.2rem 0.1rem #00000040"},"fontSize":"serinity-base","layout":{"type":"constrained","contentSize":"1280px"}} -->
  <div class="wp-block-group serinity-blur serinity-bandeau animated fadeIn has-background has-serinity-base-font-size" style="background-color:#f3ede780;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small);box-shadow:0rem 0.2rem 0.2rem 0.1rem #00000040"><!-- wp:paragraph {"align":"right","className":"serinity-emphasis","style":{"layout":{"selfStretch":"fit","flexSize":null}}} -->
  ...
  <!-- wp:cover {"url":"https://dev-cat-wp.marseaud.fr/wp-content/uploads/2025/04/priscilla-du-preez-nF8xhLMmg0c-unsplash-scaled.jpg","id":1300,"dimRatio":0,"overlayColor":"aubergine","isUserOverlayColor":true,"isDark":false,"metadata":{"name":"Expérience"},"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|taupe"}},"heading":{"color":{"text":"var:preset|color|taupe"}}},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"bottom":"var:preset|spacing|tiny","top":"var:preset|spacing|tiny"}},"color":{"duotone":["#767351","#faf8f6"]}},"textColor":"taupe","layout":{"type":"constrained","contentSize":"1280px"}} -->
  <div class="wp-block-cover aligncenter is-light has-taupe-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--tiny);padding-bottom:var(--wp--preset--spacing--tiny)" id="session-description"><span aria-hidden="true" class="wp-block-cover__background has-aubergine-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-1300" alt="" src="https://dev-cat-wp.marseaud.fr/wp-content/uploads/2025/04/priscilla-du-preez-nF8xhLMmg0c-unsplash-scaled.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained"}} -->
  <div class="wp-block-group"><!-- wp:heading {"textAlign":"center","style":{"typography":{"textDecoration":"underline","textTransform":"uppercase","fontStyle":"normal","fontWeight":"300"},"spacing":{"margin":{"bottom":"0","top":"var:preset|spacing|medium"}}},"fontSize":"large","fontFamily":"body","hasCustomCSS":true,"customCSS":".ticss-26162e1d {\n    font-size:clamp(1.375rem,.9583rem + 2.0833vw,2.625rem)\n}\n"} -->
  <h2 class="wp-block-heading has-text-align-center has-body-font-family has-large-font-size" id="en-decidant-de-vous-liberer-de-vos-traumatismes-vous-faites-un-choix-courageux-pour-votre-bien-etre" style="margin-top:var(--wp--preset--spacing--medium);margin-bottom:0;font-style:normal;font-weight:300;text-decoration:underline;text-transform:uppercase"><mark style="background-color:#faf8f6" class="has-inline-color">En décidant de vous libérer de vos traumatismes, vous faites un choix courageux pour votre bien-être</mark></h2>
  <!-- /wp:heading -->
  ...
  <!-- wp:buttons {"style":{"spacing":{"margin":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"}}},"layout":{"type":"flex","justifyContent":"center"}} -->
  <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--medium);margin-bottom:var(--wp--preset--spacing--medium)"><!-- wp:button -->
  <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://dev-cat-wp.marseaud.fr/me-contacter/">Réserver ma séance découverte gratuite</a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons --></div>
  <!-- /wp:group --></div></div>
  <!-- /wp:cover --></main>
